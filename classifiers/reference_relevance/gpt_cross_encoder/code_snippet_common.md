...
def example_integration():
    ...
    references = [
        "Our travel insurance policy is designed to keep you save. With GlobalGuard you have strong partner - whereever you are!",
    ...
    for reference in references:
        print(f"Is the {reference} relevant? Answer -> {gpt_cross_encoder(reference, question, api_key)}")
