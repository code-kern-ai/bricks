...
YOUR_ATTRIBUTE_01: str = "originals" # Choose any available attributes here.
YOUR_ATTRIBUTE_02: str = "duplicates"
MIN_LEN_SUBSTRING: int = 10
YOUR_LABEL: str = "substring"

def substring_detector(record):
    """Extracts one or multiple common substrings between two strings."""

    string1 = record[YOUR_ATTRIBUTE_01].text # SpaCy doc, hence we need to use .text to get the string.
    string2 = record[YOUR_ATTRIBUTE_02].text
