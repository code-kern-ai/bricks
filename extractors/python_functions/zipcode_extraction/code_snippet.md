...
YOUR_ATTRIBUTE: str = "text" # Choose any attribute here.
COUNTRY_ID: str = "US" # Or CA, DE. Visit GitHub for extensive list of country zip-codes
YOUR_LABEL: str = f"{COUNTRY_ID} zip code"
